...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "gamedev1p1g9", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "gamedev1p1g9";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "gamedev1p1g9", null, { width: 800, height: 600 });
