...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/writing/levelOneIntro.txt");
		types.push (lime.Assets.AssetType.TEXT);
		
		
		urls.push ("assets/writing/levelOneMain.txt");
		types.push (lime.Assets.AssetType.TEXT);
		
		
		urls.push ("assets/writing/levelThreeIntro.txt");
		types.push (lime.Assets.AssetType.TEXT);
		
		
		urls.push ("assets/writing/levelTwoIntro.txt");
		types.push (lime.Assets.AssetType.TEXT);
		
		
		urls.push ("assets/writing/levelTwoMain.txt");
		types.push (lime.Assets.AssetType.TEXT);
		
		
		urls.push ("assets/writing/outro.txt");
		types.push (lime.Assets.AssetType.TEXT);
